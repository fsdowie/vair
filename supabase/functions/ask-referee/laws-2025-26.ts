export const LAWS_2025_26 = `Laws of the Game
25/26 1

The International Football Association Board Münstergasse 9, 8001 Zurich, Switzerland T: +41 (0)44 245 1886, F: +41 (0)44 245 1887 www.theifab.com This booklet may not be reproduced or translated in whole or in part in any manner without the permission of The International Football Association Board. Selected images kindly provided by FIFA and the respective confederations, and used with their permission. Effective from 1st July 2025
...
Additional permanent concussion substitutions protocol 34
...
Poor participant behaviour is an area of increasingly great concern, and it is essential that everyone involved in the game be treated with respect to keep it enjoyable and fair. Following their successful implementation in several countries, the ‘Only the captain’ guidelines are now included as a

recommendation in the Laws, as there is widespread confidence that having only the captain approach the referee after major incidents/decisions will greatly improve interactions between the players and the referee, as well as the overall atmosphere on the field of play and the image of the game. This is vital for the game’s future, including the recruitment and retention of referees.
During 2024/25, trials were conducted to deal more effectively with goalkeepers holding the ball for too long. As a result, Law 12 has been changed so that goalkeepers will now be penalised if they hold the ball for more than eight seconds, with a corner kick being awarded to the opposition in such cases. The trials clearly demonstrated that a corner kick is an effective deterrent that is easier to manage and can be set up much more quickly than an indirect free kick in the penalty area. The eight seconds will be strictly enforced by the referee, who will visually count down the last five seconds with the fingers of a raised hand.
...
Other languages National football associations (FAs) which translate the Laws of the Game can obtain the layout template for the 2025/26 edition of the Laws from The IFAB by contacting: info@theifab.com.
...
General modifications
T he universality of the Laws of the Game means that the game is essentially the same in every part of the world and at every level. As well as creating a ‘fair’ and safe environment in which the game is played, the Laws should also promote participation and enjoyment. Historically, The IFAB has allowed national football associations (FAs) some flexibility to modify the ‘organisational’ Laws for specific categories of football. The IFAB strongly believes that national FAs should be able to modify some aspects of the way football is organised if it will benefit football in their own country. How the game is played and refereed should be the same on every football field in the world, from the FIFA World Cup™ final to the smallest village. However, the needs of a country’s domestic football should determine how long the game lasts, how many people can take part and how some unfair behaviour is punished. All national FAs (and confederations and FIFA) have the option to modify all or some of the following organisational areas of the Laws of the Game for football for which they are responsible: For all levels of the game:
...
• the implementation of the ‘Only the captain’ guidelines * See also Law 3 for the conditions that apply to matches that go to extra time and details on the restriction on substitution opportunities.

For youth, veterans, disability and grassroots football:
• size of the field of play • size, weight and material of the ball • width between the goalposts and height of the crossbar from the ground • duration of the two (equal) halves of the game (and two equal halves of
extra time) • number of players • use of return substitutes • use of temporary dismissals (sin bins) for some/all cautions (YCs) • specific requirements for the captain’s compulsory armband
...
In 2025/26, The IFAB will continue to oversee trials at lower levels of the game involving official cooling-off periods following some confrontation situations.
...
Permission for other modifications National FAs have the option to approve any of the above modifications for different competitions – there is no requirement to apply them universally or to apply them all. However, no other modifications are allowed without the permission of The IFAB. National FAs are asked to inform The IFAB of their use of these modifications, and at which levels, as this information, and especially the reason(s) why the modifications are being used, may identify development ideas or strategies which The IFAB can share to assist the development of football in other national FAs. The IFAB would also be very interested to hear about other potential modifications to the Laws of the Game which could increase participation, make football more attractive and promote its worldwide development.

‘Only the captain’ guidelines
Introduction Respect and fairness are core values of football, but referees and other match officials are regularly subjected to verbal and/or physical dissent when they make decisions. In extreme cases, players sometimes run at referees and surround or mob them, which shows a lack of respect for the referee, harms the image of the game and can be intimidating and upsetting. Stronger collaboration between the referee and the team captains can help instil fairness and mutual respect. In this regard, so that the referee can explain key decisions, only the captains will be allowed to approach the referee, provided that they do so respectfully and conduct themselves as such. At the same time, it will be the responsibility of each captain to ensure that their team-mates remain a reasonable distance from the referee and do not interfere in the interaction between the referee and the team captain(s). The following simple guidelines should assist organisers of competitions wishing to apply the ‘only the captain’ principles. Guidelines • Normal interactions between players and the referee are allowed and remain
important (to promote transparency and avoid possible frustration and conflict) • Any player (including the captain) who shows dissent by word or action will be cautioned (yellow card) • The referee will, where appropriate, explain important decisions to the captain(s) and/or the player(s) involved in an incident
...
• W here the goalkeeper is the captain, the referee must be told, no later than at the coin toss before kick-off, which player is nominated to approach the referee instead of the goalkeeper
...
A ll substituted players and substitutes are subject to the referee’s authority, whether they play or not.
...
• the referee allows the named substitute to continue playing • no disciplinary action may be taken against the named substitute • the named player can become a named substitute • the number of substitutions is not reduced • the referee reports the incident to the appropriate authorities
...
8. Player outside the field of play If a player who requires the referee’s permission to re-enter the field of play re-enters without the referee’s permission, the referee must:
...
• be in keeping with the professional appearance of the player’s equipment • not be attached to the shirt • not be dangerous to the player wearing it or any other player (e.g. opening/
...
W here EPTS are provided by the match or competition organiser, it is the responsibility of that match or competition organiser to ensure that the information and data transmitted from EPTS to the technical area during matches played in an official competition are reliable and accurate.
T he FIFA Quality Programme for EPTS supports competition organisers with the approval process of reliable and accurate electronic performance and tracking systems.
...
group, etc. • any local, regional or national government or any of its departments,
offices or functions • any organisation which is discriminatory • any organisation whose aims/actions are likely to offend a notable
...
• takes action against team officials who fail to act in a responsible manner and warns or shows a yellow card for a caution or a red card for a sending-off from the field of play and its immediate surrounds, including the technical area; if the offender cannot be identified, the senior coach present

in the technical area will receive the sanction. A medical team official who commits a sending-off offence may remain if the team has no other medical person available, and act if a player needs medical attention • acts on the advice of other match officials regarding incidents that the referee has not seen
Injuries
...
the opponent is cautioned or sent off (e.g. reckless or serious foul challenge), if the assessment/treatment is completed quickly • a penalty kick has been awarded and the injured player will be the kicker
...
– a llow play to continue if it does not interfere with play and have it removed at the earliest possible opportunity
• allows no unauthorised persons to enter the field of play
4. Video assistant referee (VAR) The use of video assistant referees (VARs) is only permitted where the match/ competition organiser has fulfilled all Implementation Assistance and Approval Programme (IAAP) requirements as set out in FIFA’s IAAP documents, and has received written permission from FIFA.
...
• goal/no goal • penalty/no penalty • direct red card (not second caution) • mistaken identity when the referee cautions or sends off the wrong player of
the offending team
...
Check – ﬁnger to ear, other hand/arm ex

• Red and yellow card

Check – nger to ear, o Check: finger to ear, other hand/arm extended

Review: ‘TV signal’

Countdown for the last five seconds of the

Review – TV Signaleight-second restriction on goalkeepers

controlling the ball with their hand(s)/arm(s)
...
in spectator areas • to stop or not to stop play to allow an injured player to be removed from the
field of play for treatment • to require an injured player to be removed from the field of play for
treatment • to allow or not to allow a player to wear certain clothing or equipment • where the referee has the authority, to allow or not to allow any persons
...
• touches a player before it touches the ground • leaves the field of play after it touches the ground, without touching a player If a dropped ball enters the goal without touching at least two players, play is restarted with:
...
referee stops play for any offence; the kicker may not play the ball a second time • The referee keeps a record of the kicks • If the goalkeeper commits an offence and, as a result, the kick is retaken,
the goalkeeper is warned for the first offence and cautioned for any subsequent offence(s) • If the kicker is penalised for an offence committed after the referee has signalled for the kick to be taken, that kick is recorded as missed and the kicker is cautioned • If both the goalkeeper and the kicker commit an offence at the same time, the kick is recorded as missed and the kicker is cautioned
...
• delaying the restart of play • dissent by word or action • entering, re-entering or deliberately leaving the field of play without the
...
• appearing to take a throw-in but suddenly leaving it to a team-mate to take • delaying leaving the field of play when being substituted • excessively delaying a restart • kicking or carrying the ball away, or provoking a confrontation by
deliberately touching the ball after the referee has stopped play • taking a free kick from the wrong position to force a retake
...
• deliberately leaving the technical area to: • show dissent towards, or remonstrate with, a match official • act in a provocative or inflammatory manner
...
• a team-mate of the goalkeeper is penalised for encroachment only if: • the encroachment clearly impacted on the kicker; or • the encroaching player plays the ball or challenges an opponent for the ball and this prevents the opponents from scoring, attempting to score or creating a goal-scoring opportunity

• the player taking the penalty kick or a team-mate offends:
• if the ball enters the goal, the kick is retaken • if the ball does not enter the goal, the referee stops play and restarts with
...
• if the ball enters the goal, a goal is awarded • if the ball misses the goal or rebounds from the crossbar or goalpost(s),
...
• an indirect free kick (or direct free kick for a handball offence) is awarded • the ball is touched by an outside agent as it moves forward:
...
• the ball rebounds into the field of play from the goalkeeper, the crossbar or the goalposts and is then touched by an outside agent: • the referee stops play • play is restarted with a dropped ball at the position where it touched the outside agent
...
Impact: penalty is retaken No impact: goal
...
Goalkeeper and kicker offend at the same time Ball kicked backwards
‘Illegal’ feinting
Wrong kicker
...
Not saved: penalty is not retaken (unless kicker is clearly impacted) Saved: penalty is retaken and warning for goalkeeper; caution for any further offence(s) Indirect free kick and caution for kicker
Indirect free kick
Indirect free kick and caution for kicker Indirect free kick and caution for wrong kicker
...
1. Principles The use of VARs in football matches is based on a number of principles, all of which must apply in every match using VARs.
...
a. Goal/no goal b. Penalty/no penalty c. Direct red card (not second yellow card/caution) d. Mistaken identity (when the referee cautions or sends off the
...
• DOGSO (especially position of offence and positions of other players) • serious foul play (or reckless challenge) • violent conduct, biting or spitting at another person • using offensive, insulting or abusive action(s)
d. Mistaken identity (red or yellow card) If the referee penalises an offence and then gives the wrong player from the offending (penalised) team a yellow or red card, the identity of the offender can be reviewed; the actual offence itself cannot be reviewed unless it relates to a goal, penalty incident or direct red card.
...
• malfunction(s) of the VAR technology (as for goal line technology (GLT)) • wrong decision(s) involving the VAR (as the VAR is a match official) • decision(s) not to review an incident • review(s) of a non-reviewable situation/decision
Incapacitated VAR, AVAR or replay operator Law 6 – The Other Match Officials stipulates: ‘Competition rules must state clearly who replaces a match official who is unable to start or continue and any associated changes.’ In matches using VARs, this also applies to replay operators.
...
Outline summary of Law changes
Law 3 – The Players • Competitions have the option of implementing the ‘Only the captain’
guidelines
Law 5 – The Referee • Signal to be used by referees to count down the last five seconds of the
eight-second restriction on goalkeepers controlling the ball with their hand(s)/arm(s)
Law 8 – The Start and Restart of Play – Dropped ball • If, when play was stopped, the ball was:
...
Law 9 – The Ball in and out of Play • Indirect free kick and no disciplinary sanction when a team official,
substitute, substituted or sent-off player or player who is temporarily off the field of play touches the ball as it is leaving the field of play and there is no intention to interfere unfairly
Law 11 – Offside • When the goalkeeper throws the ball, the last point of contact should be used
for the purpose of determining an offside position

Law 12 – Fouls and Misconduct • A goalkeeper who controls the ball with their hand(s)/arm(s) for more than
eight seconds will be penalised, with a corner kick being awarded to the other team Law 16 – The Goal Kick • Reference to other Laws detailing situations which result in a goal kick Law 17 – The Corner Kick • Reference to other Laws detailing situations which result in a corner kick • Kick to be taken from the corner area nearest to the goalkeeper’s position when penalised Video assistant referee (VAR) protocol • Competitions have the option for the referee to make an announcement after a VAR ‘review’ or lengthy VAR ‘check’

Details of all Law changes
The following are the changes to the Laws of the Game for the 2025/26 edition. For each change, the amended or additional wording is provided together with the previous wording, where appropriate, followed by an explanation of the change. Key The main Law changes are underlined in yellow and highlighted in the margin. Editorial changes are underlined. YC = yellow card (caution); RC = red card (sending-off ).
Law 3 – The Players (p. 61) 10. Team captain Additional text Each team must have a captain on the field of play who wears an identifying armband. The team captain has no special status or privileges but has a degree of responsibility for the behaviour of the team. Competitions may implement the ‘Only the captain’ guidelines listed under ‘Notes and modifications’.
Explanation Competitions are encouraged to use the ‘Only the captain’ guidelines to improve on-field behaviour and to enhance cooperation and strengthen the rapport between the players and the referee.

Law 5 – The Referee (p. 76) 6. Referee signals (…)
...
Law 8 – The Start and Restart of Play (p. 92)
2. Dropped ball Amended text Procedure • The ball is dropped for the defending team goalkeeper in their penalty area if,
when play was stopped: · the ball was in the penalty area or · the last touch of the ball was in the penalty area • In all other cases, the referee drops the ball for one player of the team that last touched the ball at the position where it last touched a player, an outside agent or, as outlined in Law 9.1, a match official • If, when play was stopped: · the ball was inside the penalty area, the referee drops it for the defending
team goalkeeper in their penalty area

· t he ball was outside the penalty area, the referee drops it for one player of the team that has or would have gained possession if this can be determined by the referee; otherwise, it is dropped for one player of the team that last touched it. The ball is dropped at its position when play was stopped
• (…)
Explanation There are times when the ball would clearly have gone to an opponent of the team that last touched the ball. In such instances, it is fairer for the ball to be dropped for the team that would have gained possession, as long as this is clear to the referee. Outside the penalty area, the ball will now be dropped at its position when play was stopped.
Law 9 – The Ball in and out of Play (p. 95) 2. Ball in play Additional text The ball is in play at all other times (…) and remains on the field of play. If, without intending to interfere with play unfairly, a team official, substitute, substituted or sent-off player or player who is temporarily off the field of play (injury, adjusting equipment etc.) touches the ball while it is still in play but when it is clearly leaving the field of play, this is penalised with an indirect free kick; there is no sanction.
Explanation There are times when a coach, substitute or player who is temporarily off the field of play (among others) touches the ball as it is going out of play with the intention of helping the game restart quickly. In such cases, an indirect free kick will be awarded but there will be no disciplinary sanction, unless such a sanction is to be issued for persistently leaving the technical area.

Law 11 – Offside (p. 103)
2. Offside offence Additional text * The first point of contact of the ‘play’ or ‘touch’ of the ball should be used; however, when the ball is thrown by the goalkeeper, the last point of contact should be used.
Explanation
...
Law 12 – Fouls and Misconduct (p. 113)
2. Indirect free kick Amended text (…) An indirect free kick is awarded if a goalkeeper, inside their penalty area, commits any of the following offences: • controls the ball with the hand/arm for more than six seconds before releasing it • touches the ball with the hand/arm after releasing it and before it has touched
another player • touches the ball with the hand/arm, unless the goalkeeper has clearly kicked
or attempted to kick the ball to release it into play, after: · it has been deliberately kicked to the goalkeeper by a team-mate · receiving it directly from a throw-in taken by a team-mate A goalkeeper is considered to be in control of the ball with the hand(s) when: • the ball is between the hands or between the hand and any surface (e.g. ground, own body) or by touching it with any part of the hands or arms, except if the ball rebounds from the goalkeeper or the goalkeeper has made a save • holding the ball in the outstretched open hand • bouncing it on the ground or throwing it in the air

A goalkeeper cannot be challenged by an opponent when in control of the ball with the hand(s). (…) 3. Corner kick A corner kick is awarded if a goalkeeper, inside their penalty area, controls the ball with their hand(s)/arm(s) for more than eight seconds before releasing it. A goalkeeper is considered to be in control of the ball with their hand(s)/arm(s) when: • the ball is between their hands/arms or between their hand(s)/arm(s) and
any surface (e.g. ground, own body) • holding the ball in their outstretched open hand(s) • bouncing it on the ground or throwing it in the air The referee will decide when the goalkeeper has control of the ball and the eight seconds begin and will visually count down the last five seconds with a raised hand. A goalkeeper cannot be challenged by an opponent when in control of the ball with their hand(s)/arm(s).
Explanation • If a goalkeeper has control of the ball with their hand(s)/arm(s) for more than
eight seconds, the referee will now award a corner kick (rather than an indirect free kick) on the side of the field closest to the goalkeeper’s position when penalised. There is no disciplinary action unless the goalkeeper repeatedly commits the offence. • To assist the goalkeeper, the referee will signal the final five seconds using a raised hand.
Renumbering of the following subsections as follows: (p. 113, 121) 4. Disciplinary action 5. Restart of play after fouls and misconduct

Law 16 – The Goal Kick (p. 139) Introduction Additional text A goal kick is awarded when the whole of the ball passes over the goal line, on the ground or in the air, having last touched a player of the attacking team, and a goal is not scored (see also Laws 8, 10, 13 and 15).
Law 17 – The Corner Kick (p. 143) Introduction Additional text A corner kick is awarded when the whole of the ball passes over the goal line, on the ground or in the air, having last touched a player of the defending team, and a goal is not scored (see also Laws 8, 12, 13, 15 and 16). (…)
1. Procedure Additional text • The ball must be placed in the corner area nearest to the point where the ball
passed over the goal line or the goalkeeper’s position when penalised

Video assistant referee (VAR) protocol (p. 153) 4. Procedures Additional text Final decision • When the review process is completed, the referee must show the ‘TV signal’
and communicate the final decision; competitions may also implement a system in which the referee publicly explains and announces decisions following a VAR ‘review’ or lengthy VAR ‘check’, as outlined in the FIFA guidelines and the VAR Handbook • ( …)
Explanation Following successful trials, competitions now have the option of the referee announcing and explaining decisions after a VAR ‘review’ or lengthy VAR ‘check’.
Glossary – Football terms (p. 176) Dropped ball Amended text A method of restarting play – the referee drops the ball for one player of the team that last touched the ball (except in the penalty area where the ball is dropped for the goalkeeper); the ball is in play when it touches the ground The restart when play has been stopped by the referee without an offence having been committed, e.g. due to injury, a defective ball etc. (see Law 8)

Practical guidelines for match officials – Positioning, movement and teamwork (p. 199)
2. Positioning and teamwork
Additional text
Penalty kick The AR must be positioned at the intersection of the goal line and the penalty area. Where the goal line can be checked for goalkeeper encroachment and goal/no goal through the use of technology (e.g. GLT, the VAR system), it is recommended that the assistant referee be positioned on the touchline, in line with the penalty mark (which is the offside line), as being on the goal line creates a risk that they may not be able to get back into a position to judge offside if the kick rebounds. Where there are AARs, the AAR must be positioned at the intersection of the goal line and the goal area and the AR is positioned in line with the penalty mark (which is the offside line).
...
Football terms
A
Abandon To end/terminate a match before the scheduled finish Additional time Time allowed at the end of each half for time ‘lost’ because of substitutions, injuries, disciplinary action, goal celebrations etc. Advantage The referee allows play to continue when an offence has occurred if this benefits the non-offending team Assessment of injured player Quick examination of an injury, usually by a medical person, to see if the player requires treatment Away goals rule Method of deciding a match/tie when both teams have scored the same number of goals; goals scored away from home count double

B
Brutality An act which is savage, ruthless or deliberately violent
C
Caution Disciplinary sanction which results in a report to a disciplinary authority; indicated by showing a yellow card; two cautions in a match result in a player or team official being sent off Challenge An action when a player competes/contests with an opponent for the ball Charge (an opponent) Physical challenge against an opponent, usually using the shoulder and upper arm (which is kept close to the body) Concussion substitution A competition option that allows each team to make an extra substitution (and grants them an extra substitution opportunity, where applicable) if one of their players suffers an actual or suspected concussion See ‘Additional permanent concussion substitutions protocol’ ‘Cooling’ break In the interests of player welfare and safety, competition rules may allow, in certain weather conditions (high humidity and temperatures), ‘cooling’ breaks (usually ninety seconds to three minutes) to allow the body’s temperature to fall; these are different from ‘drinks’ breaks
...
K
Kick The ball is kicked when a player makes contact with it with the foot and/or the ankle Kicks from the penalty mark See ‘Penalties (penalty shoot-out)’
N
Negligible Insignificant, minimal
O
Offence An action which breaks/violates the Laws of the Game Offensive, insulting or abusive language/action(s) Verbal or physical behaviour which is rude, hurtful, disrespectful; punishable by a sending-off (red card) Outside agent Any animal, object or structure, etc., as well as any person who is not a match official or on the team list (players, substitutes and team officials)

P
Penalise To punish, usually by stopping play and awarding a free kick or penalty kick to the opposing team (see also Advantage) Penalties (penalty shoot-out) Previously ‘Kicks from the penalty mark’ Method of deciding the result of a match by each team alternately taking kicks until one team has scored one more goal and both teams have taken the same number of kicks (unless during the first five kicks for each team, one team could not equal the other team’s score even if they scored from all their remaining kicks) Penalty shoot-out See ‘Penalties (penalty shoot-out)’ Play Action by a player which makes contact with the ball Playing distance Distance to the ball which allows a player to touch the ball by extending the foot/leg or jumping or, for goalkeepers, jumping with arms extended. Distance depends on the physical size of the player
Q
Quick free kick A free kick taken (with the referee’s permission) very quickly after play was stopped

R
Reckless Any action (usually a tackle or challenge) by a player which disregards (ignores) the danger to, or consequences for, the opponent Restart Any method of resuming play after it has been stopped Restart position A player’s position at a restart is determined by the position of their feet or any part of their body which is touching the ground, except as outlined in Law 11 – Offside
S
Sanction Disciplinary action taken by the referee Save An action by a player to stop or attempt to stop the ball when it is going into or very close to the goal using any part of the body except the hands/arms (unless a goalkeeper within their own penalty area) Sending-off Disciplinary action when a player is required to leave the field for the remainder of the match having committed a sending-off offence (indicated by a red card); if the match has started the player cannot be replaced. A team official may also be sent off. Serious foul play A tackle or challenge for the ball that endangers the safety of an opponent or uses excessive force or brutality; punishable by a sending-off (red card)
